...
def create_market_data_logging(service_name: str = "MarketDataService") -> MarketDataServiceLogging:
    """Create a MarketDataServiceLogging instance for easy integration."""
    return MarketDataServiceLogging(service_name=service_name)


# Direct integration functions for existing MarketDataService methods
def integrate_with_market_data_service(service_instance):
    """
    ...
    logging_integration = create_market_data_logging()
