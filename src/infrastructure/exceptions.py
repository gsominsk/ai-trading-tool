...
This module provides a structured exception system for all API clients
in the infrastructure layer. It provides rich context for debugging and logging.
...
class ApiClientError(Exception):
    """
    Base exception class for all API client errors in the infrastructure layer.
    
    Provides rich context for debugging and logging integration.
    All client-specific exceptions should inherit from this base class.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize ApiClientError with rich context.
...
class ValidationError(ApiClientError, ValueError):
    """
...
class ProcessingError(ApiClientError):
    """
